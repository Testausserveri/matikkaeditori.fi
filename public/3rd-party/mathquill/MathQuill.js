...
(function() {
    ...
    function getInterface(v) {
      ...
      APIClasses.EditableField = P(AbstractMathQuill, function(_, super_) {
        ...
        _.cmd = function(cmd) {
          ...
          if (/^\\[a-z]+$/i.test(cmd)) {
            cmd = cmd.slice(1);
            var klass = LatexCmds[cmd] || Environments[cmd]; // See environments patch below
            if (klass) {
              cmd = klass(cmd);
    ...
    */
    ...
    /**
     * ----------------------------------------------------
     * Patch from @digabi/mathquill to create blank fields
     * ----------------------------------------------------
     */
    LatexCmds['\u222b'] =
    LatexCmds['int'] =
    ...
    /**
     * ----------------------------------------------------
     * Patch from @digabi/mathquill to add \hat
     * ----------------------------------------------------
     */
    ...
    /**
     * ----------------------------------------------------
     * Patch from @digabi/mathquill to add \vec \tilde
     * ----------------------------------------------------
     */
    ...
    /**
     * ----------------------------------------------------
     * Patch from @digabi/mathquill to add LaTeX environments
     * ----------------------------------------------------
     */
    // LaTeX environments
